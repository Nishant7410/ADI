...
size=s;
  ...
  {
  if(isEmpty())
    return null;  // returns (but does not remove) the last element
  ...
  /*public static boolean check(Node<E>slow,Node<E>fast)
  {
  static Node<E> temp;
  if(fast==null)
  {
...
//  }
  ...
  public void merge(SinglyLinkedList<E> s,SinglyLinkedList<E> b)
  {
      ...
      {
          if(first.getElement().compareTo(second.getElement()))
          {
